...
config = {
  function: {
    ...
    bufferToUint16Mul04: (buffer) => (config.function.bufferToDataView(buffer).getUint16()*0.4),
    ...
    bufferToInt16: (buffer) => config.function.bufferToDataView(buffer).getInt16(),
    bufferToInt16Div10: (buffer) => (config.function.bufferToDataView(buffer).getInt16()/10.0),
    bufferToInt16Div100: (buffer) => (config.function.bufferToDataView(buffer).getInt16()/100.0),
    bufferToInt16Div1000: (buffer) => (config.function.bufferToDataView(buffer).getInt16()/1000.0),
    bufferToInt16Mul10: (buffer) => (config.function.bufferToDataView(buffer).getInt16()*10.0),
    bufferToInt16Mul100: (buffer) => (config.function.bufferToDataView(buffer).getInt16()*100.0),
    bufferToInt16Mul1000: (buffer) => (config.function.bufferToDataView(buffer).getInt16()*1000.0),
